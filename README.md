...
- Apple Health metric tiles for activity, sleep, recovery, heart metrics, VO2 Max, Body Battery, and Strain
- Detail charts with week, month, 3-month, 6-month, and yearly views
- Line, bar, and area chart modes
- Median and baseline overlays with screen-safe labels
- Trend indicators that compare current values with the user's recent personal median
- Chat-based interpretation using Apple Intelligence on supported devices
- Local rule-based insights when Apple Intelligence is unavailable
- Privacy-focused design with no analytics SDKs or external health-data upload
